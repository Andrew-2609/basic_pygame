...
pygame.draw.circle(display_surface, RED, (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 - 50), 200, 0)
pygame.draw.circle(display_surface, WHITE, (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 + 25), 167, 0)
